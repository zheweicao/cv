...
%                                                                              %
%  file:   czc-cv.tex                                                      %
%  author: Cody Zhewei Cao <zhewei@umich.edu>                               %
%                                                                              %
%==============================================================================%
...
\usepackage[osf,semibold]{ebgaramond}% EB Garamond font, with old-style figures
...
\begin{flushleft}
  ...
  \hfill
  \pbox[t]{\textwidth}{%
    \makebox[15pt][c]{\faPencil} \href{mailto:zhewei@umich.edu}{\ttfamily zhewei@umich.edu}\\
    \makebox[15pt][c]{\faRocket} \href{https://zheweicao.github.io/}{\ttfamily zheweicao.github.io}\\
    \makebox[15pt][c]{\faGithub} \href{https://github.com/zheweicao}{\ttfamily zheweicao}\\
...
\begin{cvsection}
  2010--2015 & \bodybox{%
    Ph.D., Cognition \emph{\&} Cognitive Neuroscience, University of Michigan, Ann Arbor, MI, USA.\\
    {\footnotesize Supervisor: David Brang, Jon Brennan}
  }\\
...
%   }\\
  2017--2020 & \bodybox{%
    B.S.,Brain and Cognitive Sciences, Honors, University of Rochester, Rochester, NY, USA..
  }\\
  2016--2017 & \bodybox{%
     Study Abroad Program, SUNY Buffalo, Buffalo, NY, USA.\\
     {\footnotesize (Permits candidates from mainland China to take undergraduate courses in US colleges.)}
   }\\
  2010--2013 & Suzhou High School, Suzhou, Jiangsu, China.\\
\end{cvsection}
...
\begin{cvsection}
  2021 & \fullcite{buccola.kriz.chemla2021}.\\
...
\begin{cvsection}
  upcoming & \fullcite{buccola.haida2021oi2modinf}.\\
...
\begin{cvsection}
  ...
  Journals & \emph{Acta Linguistica Academica}; \emph{Glossa}; \emph{Journal of Logic, Language and Information}; \emph{Journal of Semantics}; \emph{Language and Linguistics Compass}; \emph{Linguistics and Philosophy}; \emph{Natural Language Semantics}; \emph{Semantics and Pragmatics}.\\
  \datebox{%
    Conferences\\
